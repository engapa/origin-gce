...
# Instance groups
( teardown "{{ provision_prefix }}-ig-m" compute instance-groups unmanaged --zone "{{ gce_zone_name }}" ) &
( teardown "{{ provision_prefix }}-ig-n" compute instance-groups unmanaged --zone "{{ gce_zone_name }}" ) &
( teardown "{{ provision_prefix }}-ig-i" compute instance-groups unmanaged --zone "{{ gce_zone_name }}" ) &

# Instance with GPUs
( teardown "{{ provision_prefix }}-ig-n-gpu" compute instance-groups unmanaged --zone "{{ gce_zone_name }}" ) &
